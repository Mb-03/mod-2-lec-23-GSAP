...
const GsapText = () => {
  ...
  //   useGSAP(
  //     () => {
  //       const split = new SplitText(".text1", { tipe: "chars" });
  ...
  //   useGSAP(
  //     () => {
  //       const split = new SplitText(".text3", { tipe: "words" });
  ...
  //   useGSAP(
  //     () => {
  //       const split = new SplitText(".text4", { tipe: "chars" });
  //       gsap.from(split.chars, {
  //         opacity: 0,
  ...
  useGSAP(
    () => {
      const split = new SplitText(".text5", { tipe: "chars" });
      gsap.fromTo(
        split.chars,
        {
          color: "#8b5cf6",
