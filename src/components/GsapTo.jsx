...
const GsapTo = () => {
  ...
  useGSAP(
    () => {
      tl5.current = gsap.timeline({ paused: true, repeat: -1, yoyo: true });
      ...
      tl5.current
        ...
        .to(
          ".ctrl-box3",
          { x: 100, duration: 2, ease: "elastic.out(1, 0.3)" },
          "-=0.5"
        )
  ...
  return (
    <div
      className="min-h-dvh bg-linear-to-br from-blue-400 to-purple-500"
      ref={container}
    >
      <div className="max-w-4xl mx-auto space-y-16">
        <div className="text-center">
          ...
          <p className="text-white text-xl">Watch the box move! </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
          ...
          <div className="bg-slate-800/50 rounded-2xl p-6 h-44 space-y-3">
